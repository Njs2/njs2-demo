class ExampleAuthBasicJwtAction extends baseAction {
  async executeMethod() {
    /*
      ...
      Steps:  
      1. Pass the token in the header of the request as access_token, which is generated by the example/authBasicJwtCreate API.
      2. Njs2 itself decrypts the access_token and returns the data, i.e. user_id, in the userObj object.
    */
