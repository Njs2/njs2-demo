class ExampleMongoCreateUserAction extends baseAction {
  async executeMethod() {
    ...
    2. You have to install the njs2-mongo package (npm install @njs2/mongo)
    ...
    4. Read the file library/mongoLib/model/user.js to see how to create a user schema, model and indexing.
         (NOTE: you can use "njs2 library mongoLib user mongo" to create a user schema, model and indexing) //TODO cammand and then file read...
